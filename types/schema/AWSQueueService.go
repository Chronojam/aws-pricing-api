...
type AWSQueueService struct {
	...
	Terms		map[string]map[string]map[string]AWSQueueService_Term
}
type AWSQueueService_Product struct {	Attributes	AWSQueueService_Product_Attributes
	Sku	string
	ProductFamily	string
}
type AWSQueueService_Product_Attributes struct {	ToLocation	string
