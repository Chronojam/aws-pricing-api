...
type AWSDatabaseMigrationSvc struct {
	...
	Terms		map[string]map[string]AWSDatabaseMigrationSvc_Term
}
type AWSDatabaseMigrationSvc_Product struct {	Sku	string
	ProductFamily	string
	Attributes	AWSDatabaseMigrationSvc_Product_Attributes
}
type AWSDatabaseMigrationSvc_Product_Attributes struct {	Operation	string
	Servicecode	string
	TransferType	string
	FromLocation	string
...
type AWSDatabaseMigrationSvc_Term struct {
	...
	PriceDimensions AWSDatabaseMigrationSvc_Term_PriceDimensions
